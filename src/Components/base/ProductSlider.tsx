      ...
      >
        <SwiperSlide>
          <div className="w-full h-[600px] flex items-center justify-center">
            <img src="./logo.png" alt="Product 1" className='w-1/2' />
        ...
        <SwiperSlide>
          <div className="w-full h-[600px] flex items-center justify-center">
            <img src="./logo.png" alt="Product 2" className='w-1/2' />
            <div className="flex flex-col mt-4 w-1/2">
              <QualityItem />
              <QualityItem />
              <QualityItem />
...
const QualityItem = () => {
  return (
    <div className="flex items-center">
      <img src="./logo.png" alt="Quality Item" className="w-1/3 h-40 mb-4" />
      <div>
        <h3 className="text-lg font-semibold">Quality Item</h3>
        <p className="text-gray-600">Description of the quality item.</p>
      </div>
    </div>
  );
}
